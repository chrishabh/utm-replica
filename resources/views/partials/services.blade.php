<section id="services">
    ...
    <div class="row services_secondRow">
        ...
        <div class="row services_firstRow">
            ...
            <div class="col-6 services_rowRight">
                <div class="services_img">
                    <img src="{{ asset('assets/images/creative/search_engine.png') }}" alt="search-engine"
                        srcset="">
                </div>
            </div>
        </div>
        <div class="row services_firstRow">
            <div class="col-6 services_rowLeft">
                <div class="services_img">
                    <img src="{{ asset('assets/images/creative/video_ad.png') }}" alt="search-video-ad"
                        srcset="">
                </div>
            </div>
            <div class="col-6 services_rowRight">
        ...
        <div class="row services_firstRow">
            ...
            <div class="col-6 services_rowRight">
                <div class="services_img">
                    <img src="{{ asset('assets/images/creative/about1.png') }}" alt="native-ad"
                        srcset="">
                </div>
            </div>
        </div>
        ...
        <div class="row services_secondRow">
            <div class="col-6 services_rowLeft">
                <div class="services_img">
                    <img src="{{ asset('assets/images/creative/social_media.png') }}" alt="social-media"
                        srcset="">
                </div>
            </div>
            <div class="col-6 services_rowRight">
        ...
        <div class="row services_firstRow">
            ...
            <div class="col-6 services_rowRight">
                <div class="services_img">
                    <img src="{{ asset('assets/images/creative/initial_media.png') }}" alt="initial-media"
                        srcset="">
                </div>
            </div>
        </div>
        ...
        <div class="row services_secondRow">
            <div class="col-6 services_rowLeft">
                <div class="services_img">
                    <img src="{{ asset('assets/images/creative/digital_shopping.png') }}"
                        alt="digial-shopping-media" srcset="">
                </div>
            </div>
            <div class="col-6 services_rowRight">
