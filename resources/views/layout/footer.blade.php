        ...
        <div class="footer-cta pt-5 pb-5">
            <div class="row">
                ...
                <div class="col-xl-4 col-md-4 mb-30">
                    <!-- <div class="single-cta">
                            <i class="far fa-envelope-open"></i>
                            <img src="assets/images/glyphs/mail.gif" alt="">
                            <div class="cta-text">
                                <h4>Mail us</h4>
                        ...
                        <div class="subscribe-form">
                            <form action="/" method="POST">
                                ...
                                <button type="submit" name="sub_submit"><svg class="svg-inline--fa fa-telegram"
                                    ...
                                    </svg><!-- <i class="fab fa-telegram-plane"></i> Font Awesome fontawesome.com --></button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script src="{{ asset('assets/js/vendor/bootstrap.bundle.min.js') }}" type="text/javascript"></script>
...
<!-- OWL CARAOUSAL JS (START) -->
<script src="{{ asset('assets/js/vendor/owl.carousel.min.js') }}" type="text/javascript"></script>
<!-- OWL CARAOUSAL JS (END) -->

<!-- GSAP SCRIPT JS (START) -->
<script src="{{ asset('assets/js/vendor/gsap.min.js') }}" type="text/javascript"></script>
<!-- GSAP SCRIPT JS (END) -->

<!-- FONTAWESOME JS (START) -->
<script src="{{ asset('assets/js/vendor/fontawesome.min.js') }}" type="text/javascript"></script>
<!-- FONTAWESOME JS (END) -->

<script src="{{ asset('assets/js/vendor/sweetalert.min.js') }}" type="text/javascript"></script>
